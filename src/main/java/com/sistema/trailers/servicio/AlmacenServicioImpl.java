...
public class AlmacenServicioImpl implements AlmacenServicio {
	...
	// Esta anotación sirve para indicar que este metodo se va a ejecutar cada vez
	// que hagmaos una nueva instancia.
	@PostConstruct
	@Override
	...
	public String alamacenarArchivo(MultipartFile archivo) {
		...
		try {
			...
			throw new AlmacenExcepcion("Error al almacenar archivo" + nombreArchivo, exception);
